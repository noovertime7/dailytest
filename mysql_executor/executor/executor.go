...
type Db interface {
	...
	Transact(qs ...string) (map[string]driver.Result, error)
...
func newConn(entry *logrus.Entry, instance *DSN, schema string) (*BaseConn, error) {
	var db *sql.DB
	var err error
...
func (c *BaseConn) Transact(qs ...string) (map[string]driver.Result, error) {
	var err error
	var tx *sql.Tx
...
func NewExecutor(entry *logrus.Entry, instance *DSN, schema string) (*Executor, error) {
...
func Ping(entry *logrus.Entry, instance *DSN) error {
